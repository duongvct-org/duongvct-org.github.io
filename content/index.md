...
<div style="grid-column: 1 / -1;" class="hero panel">
  <div class="description">
    ...
    <div class="salute">
    <span>
      Hello! I'm Duong Vu Cong Tuan, a software developer and a senior at PTIT, Hanoi, Vietnam. I build things — mainly backend systems, distributed services, and the occasional shell from scratch.
    </span>
    </div>
  </div>
</div>
    ...
    <li>
      <div style="width: 100%;">
        ...
        <ul class="description bullet">
          ...
          <li>Worked in a large distributed system built on OpenStack and other services</li>
        </ul>
